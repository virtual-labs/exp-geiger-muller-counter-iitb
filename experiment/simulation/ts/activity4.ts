...
var sel_step_up_voltage: number;
var sel_source: string;
var sel_interval: number;
...
function enable_btn() {
    let ele: HTMLSelectElement = <HTMLSelectElement> document.getElementById('start-v');
    let btn: HTMLButtonElement = <HTMLButtonElement> document.getElementById('values-btn');
    let step_ele: HTMLSelectElement = <HTMLSelectElement> document.getElementById('step');
    let source_ele: HTMLSelectElement = <HTMLSelectElement> document.getElementById('source');
...
function load_start_voltage() {
    let ele: HTMLSelectElement = <HTMLSelectElement> document.getElementById('start-v');
    let step: HTMLSelectElement = <HTMLSelectElement> document.getElementById('step');
...
function set_selected_values() {
    ...
    let source: HTMLSelectElement = < HTMLSelectElement> document.getElementById('source');
    sel_source = source.value;

    let inteval: HTMLSelectElement = < HTMLSelectElement> document.getElementById('interval');
...
function populate_main_data_table(arr: number[], steps: number, num:number) {
...
function generate_table_data() {
    ...
    let dsp_cd: HTMLInputElement = <HTMLInputElement> document.getElementById("dsp-cd");
    let dsp_count: HTMLInputElement = <HTMLInputElement> document.getElementById("dsp-count");
    let btn: HTMLButtonElement = <HTMLButtonElement> document.getElementById('values-btn');
